...
## Book Repository, Flask Web Application
## Description

 This repository contains an implementation of the domain model Flask application that renders content of a Book object instance from our domain model on a simple html website. With auth, Search, reviews, users implemented. Website is static html, with css
...
## Executing the pytest unit tests

To test memory repository you can call 
````shell
$  python -m pytest tests 

```` 
To test database repository you can call 
````shell
